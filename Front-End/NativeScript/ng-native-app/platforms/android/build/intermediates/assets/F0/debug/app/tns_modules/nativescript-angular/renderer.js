    ...
    Object.defineProperty(NativeScriptRootRenderer.prototype, "animationDriver", {
        get: function () {
            if (!this._animationDriver) {
                this._animationDriver = new animation_driver_1.NativeScriptAnimationDriver();
            }
...
var NativeScriptRenderer = (function (_super) {
    ...
    function NativeScriptRenderer(rootRenderer, componentProto, animationDriver, zone) {
        ...
        _this.rootRenderer = rootRenderer;
        _this.componentProto = componentProto;
        _this.animationDriver = animationDriver;
        _this.zone = zone;
        _this.attrReplacer = new RegExp(utils_1.escapeRegexSymbols(exports.CONTENT_ATTR), "g");
        _this.attrSanitizer = /-/g;
        var stylesLength = _this.componentProto.styles.length;
        _this.componentProtoId = _this.componentProto.id;
        for (var i = 0; i < stylesLength; i++) {
            _this.hasComponentStyles = true;
            var cssString = _this.componentProto.styles[i] + "";
            var realCSS = _this.replaceNgAttribute(cssString, _this.componentProtoId);
            application_1.addCss(realCSS);
        }
...
NativeScriptRenderer = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [NativeScriptRootRenderer,
        core_1.RenderComponentType,
        animation_driver_1.NativeScriptAnimationDriver,
        core_1.NgZone])
